...
(function () {
    angular
        ...
        }).service('migrationsService', MigrationsService);

    function MigrationChart(migrationsService) {
        var $ctrl = this;
        $ctrl.options = {
            chart: {
        ...
        $ctrl.$onInit = function () {
            ...
            return migrationsService.getMigrations().then(function (migrations) {
                $ctrl.data = migrations;
            });
        };
    }

    function MigrationsService($q) {
        var migrations = $q.when([
                {
                    "key" : "Quantity" ,
                    "bar": true,
